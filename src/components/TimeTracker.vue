<template>
      ...
      <DropdownMenu>
        <div class="dropdown-container py-4 w-full h-full flex items-center">
          <div class="relative">
            ...
            <div :class="{ 'bg-green-500': isClockedIn, 'bg-gray-400': !isClockedIn }" class="absolute -right-1 top-4
 rounded-full h-2 w-2"></div>
        ...
        <ul class="bg-white w-auto rounded-xl min-w-64 absolute right-2 dropdown shadow rounded-t-none py-3">
          <li class="flex cursor-pointer px-4 py-3 mb-2 text-sm items-center justify-between relative accounts hover:bg-gray-100">
            ...
            <ul class="absolute w-auto shadow min-w-64 bg-white py-3 rounded-xl rounded-r-none dropdown-second-level -top-3 right-64">
